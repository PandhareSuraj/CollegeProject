...
<div class="px-4 sm:px-6 lg:px-8 py-8">
    <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">
        <svg class="w-10 h-10 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
            <path d="M10 8a3 3 0 100-6 3 3 0 000 6zM3.172 5.172a4 4 0 015.656 0m10 0a4 4 0 015.656 0M3 10a6 6 0 1112 0 6 6 0 01-12 0zm12 0a4 4 0 11-8 0 4 4 0 018 0z"/>
        </svg>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow mb-8">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 flex items-center gap-2">
            ...
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Requests Awaiting Trust Head Approval (Principal Approved)</h2>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <a href="{{ route('requests.index', ['status' => 'principal_approved']) }}" class="px-4 py-3 border border-amber-600 text-amber-600 font-semibold rounded-lg hover:bg-amber-50 transition text-center">Pending Approval</a>
        <a href="{{ route('requests.index', ['status' => 'trust_approved']) }}" class="px-4 py-3 border border-green-600 text-green-600 font-semibold rounded-lg hover:bg-green-50 transition text-center">Approved</a>
