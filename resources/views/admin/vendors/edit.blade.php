...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-300">Edit Vendor</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <form method="POST" action="{{ route('admin.vendors.update', $vendor->id) }}" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" id="name" name="name" required
                       ...
                       value="{{ old('name', $vendor->name) }}" placeholder="Vendor name">
            ...
            <div>
                ...
                <input type="text" id="company_name" name="company_name"
                       ...
                       value="{{ old('company_name', $vendor->company_name) }}" placeholder="Company name">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="phone" name="phone"
                           ...
                           value="{{ old('phone', $vendor->phone) }}" placeholder="+91-999999999">
            ...
            <div>
                ...
                <textarea id="address" name="address" rows="3"
                          ...
                          placeholder="Full address">{{ old('address', $vendor->address) }}</textarea>
            ...
            <div>
                ...
                <input type="text" id="gst_number" name="gst_number"
                       ...
                       value="{{ old('gst_number', $vendor->gst_number) }}" placeholder="XX AABBBB0000A1Z5">
