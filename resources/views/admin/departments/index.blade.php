        ...
        <table class="w-full text-sm">
            <thead class="theme-bg-secondary border-b theme-border-primary">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left font-semibold theme-text-primary">Teachers</th>
                    <th class="px-6 py-3 text-left font-semibold theme-text-primary">HODs</th>
                    <th class="px-6 py-3 text-left font-semibold theme-text-primary">Requests</th>
