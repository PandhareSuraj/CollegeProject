...
@section('title','Add Purchase Committee')

@section('content')
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-300">Add Purchase Committee</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <form method="POST" action="{{ route('admin.purchase-committees.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" id="name" name="name" required
                       ...
                       value="{{ old('name') }}" placeholder="Committee name">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                          ...
                          placeholder="Committee description">{{ old('description') }}</textarea>
